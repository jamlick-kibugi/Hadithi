...
import { BACKEND_URL } from "../constants";
    ...
    export default function createCollabCover(url,collabId,setCoverImage,setIsCoverLoading) {
        let illustrationUrl = ""
           ...
           if (this.status == 200) {
             ...
             .then((snapshot) => {
               ...
               return getDownloadURL(snapshot.ref);
                ...
                console.log(prompt)            
                illustrationUrl = url
                setCoverImage(illustrationUrl)                 
                setIsCoverLoading(false)
                console.log(illustrationUrl)

                const page= await axios.patch(`${BACKEND_URL}/collab/page/coverImage`,{coverUrl:illustrationUrl,
                          collabId:collabId})
