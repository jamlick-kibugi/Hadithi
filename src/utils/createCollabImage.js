...
import { BACKEND_URL } from "../constants";
    ...
    export default function createCollabImage(url,collabPageId,setPageUrl,setIsLoading) {
        let illustrationUrl = ""
           ...
           if (this.status == 200) {
             ...
             .then((snapshot) => {
               ...
               return getDownloadURL(snapshot.ref);
                ...
                const page= await axios.patch(`${BACKEND_URL}/collab/page/image`,{pageUrl:illustrationUrl,
                          collabPageId:collabPageId})
