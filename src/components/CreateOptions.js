...
const CreateOptions = ( ) => {
  return (
    ...
    <OptionCard title={"Stories"} image={"/personalisedStory.png"}  content={"Quick stories with a few simple prompts"} />
    <OptionCard title={"Collaborations"} image={"/collaborativeStory.png"} content={"Collaborate with friends, and build a world together"}  />
    </Box>
    </Box>
  )
}
